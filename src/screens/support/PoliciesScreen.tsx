    ...
    <Screen style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.paragraph}>
          ...
          estes Termos de Uso. Estes termos regem seu acesso e uso do aplicativo móvel, do
          site e de todos os serviços associados.
        </Text>
        <Text style={styles.paragraph}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.paragraph}>
          ...
          recebimento, desde que estejam em sua condição original, sem uso e na embalagem
          original.
        </Text>
        <Text style={styles.paragraph}>
          ...
          pagamento original após o recebimento e inspeção do item devolvido pelo lojista.
          Custos de frete de devolução podem ser aplicados, dependendo da política
          específica do lojista.
        </Text>
      </View>
    </Screen>
  )
